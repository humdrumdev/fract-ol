...
/*   Updated: 2022/03/12 14:09:04 by hel-moud         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	show_use(t_mlx *mlx)
{
	...
	mlx_string_put(mlx->mlx_ptr, mlx->win_ptr, X_START, 190, DEF_COLOR, USAGE9);
	mlx_string_put(mlx->mlx_ptr, mlx->win_ptr, X_START, 210, DEF_COLOR, USAGE0);
}
